...
MOdified on Wed Apr 06 16:09:08 2022
...
def get_HarneyAugmentationFromOMS(mat_file_name_path = 'C:/Users/dgorelic/Desktop/TBWruns/rrv_0125' + '/sim_0001.mat',
    ...
    print('mat_file_name_path=', mat_file_name_path)
    import h5py
    oms_file = h5py.File(mat_file_name_path, 'r')
...
if exists(dv_path) == False:
    ...
    err.write("\n")
DVs = pd.read_csv(dv_path, header=None)
...
if exists(du_path) == False:
    ...
    err.write("\n")
DUFs = pd.read_csv(du_path, header=None)
...
current_debt_targets = ""
projected_10year_CIP_spending = ""
projected_10year_CIP_spending_major_project_fraction = ""
normalized_CIP_spending = ""
