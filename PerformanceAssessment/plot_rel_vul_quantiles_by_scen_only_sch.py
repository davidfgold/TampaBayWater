...
scenario = 141
failure_criteria_percent30 = np.loadtxt('Reliability/reliability_only_SCH_' + str(scenario) + '.csv', delimiter=',')
...
palette=(colors_from_values(1-failure_criteria_percent30, "YlOrRd_r")), ax=ax, edgecolor='#838383')
ax.set_ylim([0,100])
...
plt.savefig('Figures/Reliability_only_1mgd_sch' + str(scenario) + '.png')

##############

failure_criteria_periods_30_percent = np.loadtxt('Severity/failure_duration_only_SCH_' + str(scenario) + '.csv',
 delimiter=',')
