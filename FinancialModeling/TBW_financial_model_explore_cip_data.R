...
#(2022 adds include updated CIP 10 year forecast and including 2021 data)
# ------------------------------------------
...
CIP_Forecast = read.csv(paste(hist_financial_path, '/FinancialModelForecast10yrmultiplesourcesTBWFY22.csv', sep = ''))
...
CIPF_melt_sub$variable = plyr::revalue(CIPF_melt_sub$variable, c('Remaining.FY.2022'='2022',
                                        'FY.2023'='2023', 'FY.2024'='2024', 'FY.2025'='2025',
                                        'FY.2026'='2026', 'FY.2027'='2027', 'FY.2028'='2028',
                                        'FY.2029'='2029', 'FY.2030'='2030', 'FY.2031'='2031', 'FY.2032'='2032', 
                                        'Future'='2033'))
P = ggplot(data = CIPF_melt_sub) + geom_bar(aes(x = as.integer(as.character(variable)), y = Dollars, fill = Current.Funding.Source), 
  ...
  scale_x_continuous(labels = as.character(c(seq(2021,2032), "2033+")), breaks = seq(2021,2033), name = "Fiscal Year") +
  theme(axis.text.x = element_text(angle = 45, vjust = 0.8, hjust = 0.7, size = 10), legend.position = "none",
        axis.text.y = element_text(size = 10, face = "bold"))
ggsave('C:/Users/cmpet/OneDrive/Documents/UNCTBW/Financialoutputs/check_CIPFY22.png',
...
P = ggplot(data = CIPF_melt_sub) + geom_bar(aes(x = as.integer(as.character(variable)), y = Dollars, 
                                            ...
                                            color = NA, stat = 'identity') + 
  scale_y_continuous(labels = comma, name = "Million USD") + scale_x_continuous(labels = as.character(c(seq(2021,2032), "2033+")), 
...
ggsave('C:/Users/cmpet/OneDrive/Documents/UNCTBW/Financialoutputs/check_CIP_basicFY22.png',
...
ggsave('C:/Users/cmpet/OneDrive/Documents/UNCTBW/Financialoutputs/check_CIP_bysizeFY22.png',
...
P = ggplot(data = CIPF_melt_sub) + geom_bar(aes(x = as.numeric(as.character(variable)), y = Dollars, fill = Current.Funding.Source),
  ...
  xlab("Fiscal Year\n(2033 includes all future funding TBA)") + scale_y_continuous(labels = comma)
ggsave('C:/Users/cmpet/OneDrive/Documents/UNCTBW/Financialoutputs/check_CIP_bysize_typeFY22.png',
...
print(paste("Total CIP Projects (FY21 to FY32+): ", length(unique(CIPF_melt_sub$Project.Name)), sep = ""))
for (project in unique(CIPF_melt_sub$Project.Name)) {
  # isolate each project, select just years where it is funded, re-index them 0-X rather than 2021-2031 (or 2032 for the annual update)
...
write.table(CIP_raw_schedule, sep = ",", row.names = FALSE,
            'C:/Users/cmpet/OneDrive/Documents/UNCTBW/Financialoutputs/original_CIP_spending_all_projectsFY22.csv')
...
write.table(fraction_major_project_spending, sep = ",", col.names = NA,
            'C:/Users/cmpet/OneDrive/Documents/UNCTBW/Financialoutputs/original_CIP_spending_major_projects_fractionFY22.csv')
...
write.table(all_project_schedule, sep = ",", row.names = FALSE,
            'C:/Users/cmpet/OneDrive/Documents/UNCTBW/Financialoutputs/normalized_CIP_spending_all_projectsFY22.csv')
...
write.table(fraction_cip_spending_for_major_projects_by_source, sep = ",", col.names = NA,
           'C:/Users/cmpet/OneDrive/Documents/UNCTBW/Financialoutputs/normalized_CIP_spending_major_projects_fractionFY22.csv')
...
ggsave('C:/Users/cmpet/OneDrive/Documents/UNCTBW/Financialoutputs/check_CIP_normalizedstartyear_allFY22.png',
...
P = ggplot(data = CIPF_normalizedbyyear) + geom_bar(aes(x = `Normalized Year Index`, y = Dollars, fill = Current.Funding.Source), 
  ...
  xlab("Years after First Year a Project is Funded") + scale_y_continuous(labels = comma)
ggsave('C:/Users/cmpet/OneDrive/Documents/UNCTBW/Financialoutputs/check_CIP_normalizedstartyearFY22.png',
...
ggsave('C:/Users/cmpet/OneDrive/Documents/UNCTBW/Financialoutputs/check_CIP_normalizedstartyear_relativesFY22.png',
       dpi = 600, units = 'in', height = 6, width = 12)
