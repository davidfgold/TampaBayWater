...
CIP2020_2029_melt['Total Dollars']=CIP2020_2029['Total Funds Needed'].str.replace(',', '').str.replace('$', '').astype(float)
...
for project in CIP2020_2029_melt.Project'Project Name']:
    #project_data = CIP2020_2029_melt['Project Name']
